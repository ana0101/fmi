...
--7". Scrie?i o cerere pentru a afi?a numele, numele departamentului ?i salariul angaja?ilor 
--care au salariu mai mare decât salariul mediu posibil ( (j.min_salary+j.max_salary)/2  )
...
Observa?ie: Este necesar cuvântul cheie DISTINCT. Ce obtinem daca îl omitem?
...
--lista sefilor angajatilor (inclusiv manager_id null) ---nu este corect
select distinct manager_id
...
în clauza SELECT,care nu sunt argument al functiilor grup 
