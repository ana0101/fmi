...
WHERE  lower(table_name) IN ('angajati_***','angajati_da');
...
25. (incercati sa) adaugati o noua inregistrare in tabelul ANGAJATI_pnu, care sa corespunda codului
...
insert  into angajati_***
values (105, 'Nume6', 'Prenume6', 'Nume6@gmail.com', Null, 'Analist', 101, 3000, 50, 0.2);
SQL Error: ORA-02291: constrangere de integritate (GRUPA33.FK_DEPART_***) violata - cheia parinte negasita
...
delete from departamente_***; 
--SQL Error: ORA-02292: constrangerea de integritate (GRUPA33.FK_DEPART_***) violata - gasita inregistrarea copil
...
delete from departamente_***
where cod_dep =20;
--SQL Error: ORA-02292: constrangerea de integritate (GRUPA34.FK_DEPART_***) violata - gasita inregistrarea copil
