...
loop_afisare:
	# verificam daca mai sunt linii de afisat
	movl i, %ecx
	cmp n, %ecx
	jge exit
...
loop_afisare_linie:
	...
	movl j, %ecx
	cmp n, %ecx
	jge exit_loop_afisare_linie
	
	# pregatim elementul de afisat si il punem in esi
	lea matrice, %edi
	movl n, %eax
	movl i, %ebx
	xorl %edx, %edx
