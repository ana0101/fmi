...
public class Main {
    ...
    public static void main(String[] args) {
        readUsingFileOutputStream("L7-input.txt");

        writeUsingFileOutputStream("L7-output.txt", "This is a text");
        writeUsingFileOutputStream("./L7-output.txt", "This is another text");

        writeUsingFileOutputStream("./L7-output-append.txt", "First line \n", true);
        writeUsingFileOutputStream("./L7-output-append.txt", "Second line \n", true);
    }
