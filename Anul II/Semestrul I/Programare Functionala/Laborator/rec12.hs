...
instance Applicative List where
    ...
    -- fmap o sa aplice functia tuturor elementelor din lista si o sa returneze lista cu rezultatele
    -- concatenez toate listele cu rezultate pt a o forma pe cea finala cu toate
